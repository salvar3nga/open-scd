...
## [0.36.0](https://github.com/salvar3nga/open-scd/compare/v0.37.1...v0.36.0) (2025-02-18)
...
* added acd as a supported ens type ([#1384](https://github.com/salvar3nga/open-scd/issues/1384)) ([cebcd37](https://github.com/salvar3nga/open-scd/commit/cebcd37ecbc0230561018c4bb2a8c5e58de3b807))
...
* **editors/104:** Show/edit subnetworks without redundancy ([638fbf4](https://github.com/salvar3nga/open-scd/commit/638fbf42ffa74eb63f83f5033dd25ddf32e04c5e))
...
* **editors/cleanup:** remove unused control blocks ([#620](https://github.com/salvar3nga/open-scd/issues/620)) ([e63f11f](https://github.com/salvar3nga/open-scd/commit/e63f11f9e5e2130b273506eff2567ec31a890f57))
...
* **editors/subscriber:** use filtered lists ([#638](https://github.com/salvar3nga/open-scd/issues/638)) ([f255bfb](https://github.com/salvar3nga/open-scd/commit/f255bfb4f205239413f12f7c47e221e739cefdce))
...
* **editors/Subscription:** When undo / redo actions Subscription / SMV plugin, lists are not refreshed ([7889be9](https://github.com/salvar3nga/open-scd/commit/7889be93b7d8f76042cc08656392b83f1b82dada))
...
* **editors/substation:** redirect LNode's on clone ([#1079](https://github.com/salvar3nga/open-scd/issues/1079)) ([cfd16d6](https://github.com/salvar3nga/open-scd/commit/cfd16d66e2efe13930d3537486750b8bc46b3d87))
...
* **ied-editor/ln-node:** Changed description of LN Node in IED Editor ([#647](https://github.com/salvar3nga/open-scd/issues/647)) ([9a655e8](https://github.com/salvar3nga/open-scd/commit/9a655e88d1a8341ec56a83c6af540e77f4e9c280))
...
* optional nsd upload button ([#1474](https://github.com/salvar3nga/open-scd/issues/1474)) ([a6c5d3e](https://github.com/salvar3nga/open-scd/commit/a6c5d3e55e7fd13ada773be7f56d7869e06f30c0))
...
* **wizard-dialog:** wizard-dialog content definition through `WizardInput` objects ([5f3a7a7](https://github.com/salvar3nga/open-scd/commit/5f3a7a7c4a74bffb5e800b8c75bffdbdb3213e15))
...
* **wizards/dai:** Change DAI values ([#687](https://github.com/salvar3nga/open-scd/issues/687)) ([3689ef2](https://github.com/salvar3nga/open-scd/commit/3689ef26253ba3c352f0bd758b9abdbc17fe9c33))
...
* **wizards/gsecontrol:** add create wizards ([#654](https://github.com/salvar3nga/open-scd/issues/654)) ([887f46f](https://github.com/salvar3nga/open-scd/commit/887f46f5e3bc885cfad1f9e18a2d5f58161fbb44))
...
* **wizards/reportcontrol:** add copy to other IEDs  ([#632](https://github.com/salvar3nga/open-scd/issues/632)) ([1850dfa](https://github.com/salvar3nga/open-scd/commit/1850dfa6c77669fd47ac36379a32267dc54ef913))
* **wizards/sampledvaluecontrol:** add create wizard ([#744](https://github.com/salvar3nga/open-scd/issues/744)) ([f510446](https://github.com/salvar3nga/open-scd/commit/f510446da42d20b45c57b41c4463a663b6bc712d))
...
* **wizards:** Changed label of rptID ([#697](https://github.com/salvar3nga/open-scd/issues/697)) ([10f3f0b](https://github.com/salvar3nga/open-scd/commit/10f3f0bdea05328838196914f62290e4ca6c76bc))
...
* **editors/plugin:** disable read-only inputs ([#1000](https://github.com/salvar3nga/open-scd/issues/1000)) ([e399e7e](https://github.com/salvar3nga/open-scd/commit/e399e7e3685ad0ee5fee351eed0f53703a0f6528))
...
* **editors/subscription:** several styling issues ([#661](https://github.com/salvar3nga/open-scd/issues/661)) ([b9f5555](https://github.com/salvar3nga/open-scd/commit/b9f5555c4c01c7ba29cfca12dd5f0b318abee861))
...
* **editors:** Changed selectors in Substation and IED Editors and updated IED and Substation Wizards. ([#671](https://github.com/salvar3nga/open-scd/issues/671)) ([33b590a](https://github.com/salvar3nga/open-scd/commit/33b590abdedca12d1029d950654d8d6673124e8f))
...
* **filtered-list:** allow filter nested list-item s ([#660](https://github.com/salvar3nga/open-scd/issues/660)) ([1ea37c5](https://github.com/salvar3nga/open-scd/commit/1ea37c5c490de52b538201d3a4fb39291b239771))
...
* **menu/importieds:** Transfer namespaces to document element for ied import ([#1081](https://github.com/salvar3nga/open-scd/issues/1081)) ([eccc3fc](https://github.com/salvar3nga/open-scd/commit/eccc3fc0d39e926176e9177058385851ab4f8f35))
...
* Subscribing on minimal ExtRef definition ([#1551](https://github.com/salvar3nga/open-scd/issues/1551)) ([29483e6](https://github.com/salvar3nga/open-scd/commit/29483e6562061ae1edd69b2dccf33a512a8aef93))
...
* **wizard-dialog:** make sure to close on non empty editor action ([8fb125c](https://github.com/salvar3nga/open-scd/commit/8fb125c1c353feb37a4c988d59a608090fb0425b))
* **wizard-dialog:** remove initialFocus from action buttons ([#702](https://github.com/salvar3nga/open-scd/issues/702)) ([a4783ab](https://github.com/salvar3nga/open-scd/commit/a4783ab46e350e5ed1af64102bd3a78e95fc2c93))
...
* **wizards/subnetwork:** incorrect title for create wizard ([#645](https://github.com/salvar3nga/open-scd/issues/645)) ([0210913](https://github.com/salvar3nga/open-scd/commit/0210913cc8eef9cf06d1071a146072ba24e80df0))
